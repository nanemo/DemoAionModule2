...
public class FixedOrganismActionExecutionRunnable implements Runnable {
    ...
    public FixedOrganismActionExecutionRunnable(Runnable delegate, int maxRunCount) {
    ...
    public void runNTimes(ScheduledExecutorService executor, long period, TimeUnit unit) {
        self = executor.scheduleAtFixedRate(this, 5, period, unit);
    }
}
